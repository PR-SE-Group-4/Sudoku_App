...
public class Loader {
    ...
    public static void setup() {
        ...
        if (!appdir.exists()) {
            appdir.mkdir();
            try {
                File presaved00 = new File(appdir + "\\01supereasy.txt");
                ...
                presaved00wr.close();
                File presaved01 = new File(appdir + "\\01medium.txt");
                ...
                presaved01wr.close();
                File presaved02 = new File(appdir + "\\01samurai.txt");
                ...
                presaved02wr.close();
                File presaved03 = new File(appdir + "\\01freeform.txt");
